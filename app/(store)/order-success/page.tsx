...
export default async function Page({ searchParams }: PageProps<"/order-success">) {
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="rounded-[32px] border border-brand-200 bg-white p-8 text-center shadow-sm sm:p-12">
        <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-brand-100 text-4xl text-brand-700">✓</div>
        <p className="text-sm font-semibold uppercase tracking-[0.25em] text-brand-700">Order confirmed</p>
        ...
        <div className="mt-8 rounded-[24px] bg-[#faf8f5] p-5 text-left">
