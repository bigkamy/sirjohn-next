...
export default async function ProductPage({ params }: PageProps<"/product/[slug]">) {
  ...
  const [catalog, freeShippingOver, reviews] = await Promise.all([getProducts(), getFreeShippingThreshold(), getApprovedReviews(product.id)]);
  ...
  return <ProductDetailPage product={product} related={related} freeShippingOver={freeShippingOver} reviews={reviews} />;
}
